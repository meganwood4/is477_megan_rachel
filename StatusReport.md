...
### Rachel:
One of my main contributions include documenting changes made after our Project Plan submission. After beginning the process of storing our data we realized a lot of the datasets we intended to use were not as accessible as we originally thought, so I documented that and searched for new datasets to use. Additionally, I completed the FAIR analysis on all our final datasets to ensure that all of our datasets were ethical to use. Moving forward, I will continue to document our work to ensure reproducibility and transparency, and continue to connect our research to a data lifecycle. 
